...
| `feature_engineering/` | Window feature calculators and the feature-schema validator (`validate_feature_schema.py`). | In progress |
...
| `inference/` | Inference-ready module the backend imports; must return the `InferenceResponse` contract. | Planned |
